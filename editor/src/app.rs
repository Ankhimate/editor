...
pub struct AnkhimateApp {
    ...
    /// Repository-backed catalog and background package downloads.
    marketplace: crate::plugins::Marketplace,
...
impl AnkhimateApp {
    ...
    pub fn with_file(cc: &eframe::CreationContext<'_>, open: Option<std::path::PathBuf>) -> Self {
        ...
        let plugins = crate::plugins::Plugins::directory()
            ...
            .unwrap_or_default();
        let marketplace = crate::plugins::Marketplace::fetch(&cc.egui_ctx);
...
impl Default for AnkhimateApp {
    fn default() -> Self {
        Self {
            ...
            marketplace: crate::plugins::Marketplace::default(),
...
at startup.",
        ...
        if self.show_settings {
            ...
            crate::ui::settings::ui(
                ...
                crate::ui::settings::Extensions {
                    operators: &self.operators,
                    installed: &self.plugins,
                    marketplace: &mut self.marketplace,
                },
                &mut open,
            );
            self.theme.apply(ctx);
