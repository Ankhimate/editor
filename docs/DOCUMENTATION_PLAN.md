...
- [x] Constraints deep pass: solve order, IK, transform, path, physics, setup and simulation controls, recipes, failure cases, and current animation-authoring limitations verified against implementation.
